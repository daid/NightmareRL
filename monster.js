...
MonsterBase.extend(Actor);
MonsterBase.prototype.act = function()
{
...
MonsterBase.prototype.aiMoveToPlayer = function()
{
...
MonsterBase.prototype.aiFleeFromPlayer = function()
{
	var pd = game.map[p(this.x, this.y)].player_distance;
	var deltas = ROT.DIRS[8];
	var new_x = this.x;
...
MonsterBase.prototype.aiRandomWalk = function()
{
	var deltas = ROT.DIRS[8];
...
MonsterBase.prototype.meleeAttackEnemy = function(player)
{
...
MonsterBase.prototype.playerBump = function(player)
{
	var hit_roll = rollDie("3d6");
	if (hit_roll <= player.melee_accuracy)
	{
...
MonsterBase.prototype.takeDamage = function(damage_amount, source)
{
...
MonsterBase.prototype.died = function(source)
{
}
